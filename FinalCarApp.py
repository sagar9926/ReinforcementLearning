...
coordinates = [[590,380],[730,106],[1130,405],[120,300],[1110,600]]
...
class Game:
    ...
    def __init__(self):
        ...
        self.car_img = pygame.transform.scale(self.car_img,(20,10))
        #self.car = {'x':0,'y':0,'center':[234,245],'velocity':[0,0],'view':tc.view}
        #global reward
    ...
    def runCarUi(self,carposx,carposy,desposx,desposy,tAngle):
        ...
        display_cam = np.copy(self.car.view.squeeze())
        ...
        self.screen.blit(display_cam3,(10,10)) 
